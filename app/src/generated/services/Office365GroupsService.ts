...
export class Office365GroupsService {
   ...
   */
  public static async AddMemberToGroup(groupId: string, userUpn: string): Promise<IOperationResult<void>> {
    const params: { groupId: string, userUpn: string } = { groupId, userUpn };
    const result = await Office365GroupsService.client.executeAsync<{ groupId: string, userUpn: string }, void>(
      {
        connectorOperation: {
          tableName: Office365GroupsService.dataSourceName,
   ...
   */
  public static async CreateCalendarEvent(groupId: string, body: UpdateCalendarEvent_Request): Promise<IOperationResult<void>> {
    const params: { groupId: string, body: UpdateCalendarEvent_Request } = { groupId, body };
    const result = await Office365GroupsService.client.executeAsync<{ groupId: string, body: UpdateCalendarEvent_Request }, void>(
      {
        connectorOperation: {
          tableName: Office365GroupsService.dataSourceName,
   ...
   * This operation is used to create a new event in a group calendar.
   */
  public static async CreateCalendarEventV2(groupId: string, body: UpdateCalendarEvent_HTMLRequest): Promise<IOperationResult<void>> {
    const params: { groupId: string, body: UpdateCalendarEvent_HTMLRequest } = { groupId, body };
    const result = await Office365GroupsService.client.executeAsync<{ groupId: string, body: UpdateCalendarEvent_HTMLRequest }, void>(
      {
        connectorOperation: {
          tableName: Office365GroupsService.dataSourceName,
   ...
   */
  public static async CalendarDeleteItem_V2(groupId: string, event: string): Promise<IOperationResult<void>> {
    const params: { groupId: string, event: string } = { groupId, event };
    const result = await Office365GroupsService.client.executeAsync<{ groupId: string, event: string }, void>(
      {
        connectorOperation: {
          tableName: Office365GroupsService.dataSourceName,
   ...
   */
  public static async UpdateCalendarEvent(groupId: string, event: string, body: UpdateCalendarEvent_HTMLRequest): Promise<IOperationResult<CreateCalendarEvent_Response>> {
    const params: { groupId: string, event: string, body: UpdateCalendarEvent_HTMLRequest } = { groupId, event, body };
    const result = await Office365GroupsService.client.executeAsync<{ groupId: string, event: string, body: UpdateCalendarEvent_HTMLRequest }, CreateCalendarEvent_Response>(
      {
        connectorOperation: {
          tableName: Office365GroupsService.dataSourceName,
   ...
   */
  public static async RemoveMemberFromGroup(groupId: string, userUpn: string): Promise<IOperationResult<void>> {
    const params: { groupId: string, userUpn: string } = { groupId, userUpn };
    const result = await Office365GroupsService.client.executeAsync<{ groupId: string, userUpn: string }, void>(
      {
        connectorOperation: {
   ...
   */
  public static async HttpRequestV2(Uri: string, Method: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE', Body?: string, ContentType?: string, CustomHeader1?: string, CustomHeader2?: string, CustomHeader3?: string, CustomHeader4?: string, CustomHeader5?: string): Promise<IOperationResult<ObjectWithoutType>> {
    ...
    const result = await Office365GroupsService.client.executeAsync<{ Uri: string, Method: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE', Body?: string, ContentType?: string, CustomHeader1?: string, CustomHeader2?: string, CustomHeader3?: string, CustomHeader4?: string, CustomHeader5?: string }, ObjectWithoutType>(
      {
        connectorOperation: {
          tableName: Office365GroupsService.dataSourceName,
